...
export default function RegisterPage() {
  ...
  const fillDemoAccount = () => {
    setValue("full_name", "Dr. Alex Mercer");
    setValue("email", "alex.mercer@forgemind.ai");
  ...
  return (
    <div className="min-h-screen bg-[#030712] text-slate-100 font-sans selection:bg-sky-500 selection:text-white relative overflow-hidden flex flex-col justify-between">
      ...
      <div className="absolute top-0 left-0 w-[600px] h-[600px] bg-gradient-to-br from-sky-600/15 via-cyan-500/10 to-transparent blur-[140px] pointer-events-none" />
      <div className="absolute bottom-0 right-0 w-[500px] h-[500px] bg-purple-600/10 blur-[140px] pointer-events-none" />
      ...
      <main className="flex-1 max-w-7xl w-full mx-auto grid grid-cols-1 lg:grid-cols-12 gap-8 items-center p-4 sm:p-8 my-auto">
        ...
        <div className="hidden lg:flex lg:col-span-7 flex-col space-y-8 pr-6">
          ...
          <p className="text-slate-400 text-base leading-relaxed max-w-xl">
            Join hardware engineers utilizing autonomous 6-agent AI swarms to transform product prompts into complete 3D CAD parameters, FEA stress math, and 5-axis CNC manufacturing workflows.
          </p>
          ...
          <div className="space-y-3 font-mono text-xs text-slate-300">
            <div className="flex items-center gap-2.5">
              ...
              <span>Instant 3D WebGL Parametric CAD Mesh Preview</span>
            </div>
            <div className="flex items-center gap-2.5">
              <CheckCircle2 className="w-4 h-4 text-purple-400 shrink-0" />
              <span>FEA Yield Stress & Safety Factor Validation</span>
            </div>
            <div className="flex items-center gap-2.5">
              <CheckCircle2 className="w-4 h-4 text-emerald-400 shrink-0" />
              <span>Itemized Component Sourcing & BOM Cost Matrices</span>
            </div>
            <div className="flex items-center gap-2.5">
              <CheckCircle2 className="w-4 h-4 text-rose-400 shrink-0" />
              <span>Automated ReportLab Executive PDF Report Exporter</span>
            </div>
          </div>
        </div>
          ...
          <div className="bg-slate-900/90 border border-slate-800 rounded-2xl p-6 sm:p-8 shadow-2xl backdrop-blur-xl space-y-6 relative">
            ...
            <div className="p-3 rounded-xl bg-sky-950/60 border border-sky-800/60 flex items-center justify-between gap-3 text-xs">
              <div className="flex items-center gap-2 text-sky-300">
                ...
                <span>Fill sample registration info</span>
              </div>
              <button
                type="button"
            ...
            <div className="space-y-1">
              <h2 className="text-xl sm:text-2xl font-bold tracking-tight text-slate-100">Create Account</h2>
              <p className="text-xs text-slate-400">Initialize your hardware engineering workspace</p>
            </div>
